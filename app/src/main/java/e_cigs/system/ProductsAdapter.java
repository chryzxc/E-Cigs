...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ViewHolder> {
    private List<ProductsList> myListList;
    private Context ct;
    private String loader;

    public ProductsAdapter(List<ProductsList> myListList, Context ct, String loader) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProductsList myList=myListList.get(position);
