...
public class SearchProductsAdapter extends RecyclerView.Adapter<SearchProductsAdapter.ViewHolder> {
    private List<SearchProductsList> myListList;
    private Context ct;

    public SearchProductsAdapter(List<SearchProductsList> myListList, Context ct) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        SearchProductsList myList=myListList.get(position);
