...
public class ProductsList {
    ...
    public ProductsList(String product_id,String product_type, String product_name, String product_description, String product_store, Double minimum, Double maximum, String date_added) {
